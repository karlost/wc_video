...
//include_once( TM_PATHWCVIDEO . 'components/log/log-content.php'); 
include_once( TM_PATHWCVIDEO . 'components/log/log-functions.php'); 
...
if( ! class_exists( 'logSetupWDS') )
{
	...
	class logSetupWDS
	{
        ...
        public function new_folder_wds_log() {
            ...
            $upload_dir_user = $upload_dir . '/'.TM_IDWCVIDEO;
