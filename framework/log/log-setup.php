...
if( ! class_exists( 'logSetupWDS') )
{
	...
	class logSetupWDS
	{
        ...
        public function admin_page_wds_log() {
            add_submenu_page(
                'wds-plugins',                              
                    __( 'Wedesin Log', TM_PLUGWCVIDEO ),                    
                    __('WDS Log', TM_PLUGWCVIDEO),               
                    'manage_options',                           
                    'wds-logs',                              
            ...
            <div class="wrap">
                ...
                <nav class="nav-tab-wrapper">
                    ...
                    <a href="?page=wds-logs" class="nav-tab <?= ($tab===null ? 'nav-tab-active' : '')?>">
                        <?= __('Přehled logů', TM_PLUGWCVIDEO) ?>
                    </a>
                    <?php 
...
include_once( TM_PATHWCVIDEO . 'components/log-content.php'); 
//use log\functions;
include_once( TM_PATHWCVIDEO . 'framework/log/log-functions.php'); 