<?php
namespace wc_video\framework\forms_core;
if (!defined('ABSPATH')) {
    exit;
}
...
if (!class_exists('WDS_Front_Form')) {
    class WDS_Front_Form
    {
        ...
        public function __construct($field_list = [])
        {
            ...
            $this->prefix = '_wds_'.TM_IDWCVIDEO.'_';
            ...
            $this->session = new \wc_video\framework\sessions\sessionClassWDS;
        }
                    ...
                    <div class="content">
                        ...
                        <div class="content-box">
                            ...
                            <form method="post" id="<?= $formID ?>_form" class="wds-form" action="<?php // the_permalink(); 
                                ...
                                <input type="hidden" value="<?= TM_IDWCVIDEO?>" name="plugin_id_wds" />                                                             
        ...
        public function get_form_fields($formID = null)
        {
            ...
            if (isset($validation_data['allvalid']) && !$validation_data['allvalid']) {
                ...
                <div class="notice notice-error wds-notice is-dismissible">
                    <?= '<p>'.__('Nastavení se nepodařilo uložit. Formulář obsahuje chyby. Zkontrolujte správnost vyplnění následujících položek.', TM_PLUGWCVIDEO). '</p>'?>
                ...
                <div class="notice notice-success wds-notice is-dismissible">
                    <?= '<p>'. __('Nastavení bylo uloženo.', TM_PLUGWCVIDEO) . '</p>' ?>
                    <button type="button" class="notice-dismiss"><span class="screen-reader-text">Skrýt toto upozornění.</span></button>
                </div>
                <?php
            }
        ...
        public function get_input_html($type, $name, $value, $args = [], $is_valid = true)
        {
            ...
            switch ($type) {
                ...
                case 'url':
                    ...
                    echo '<span class="input-group-label">' . wds_get_svg(TM_URLWCVIDEO . "assets/icons/link-line.svg") . '</span>';
                    echo  $floating_label_start;
                ...
                case 'image':
                    ...
                    echo '<a href="#" id="wds-media-upload" class="button">' . wds_get_svg(TM_URLWCVIDEO . "assets/icons/upload-cloud-line.svg") . 'Nahrát</a>';
                    ...
                    if ($value) {
                        ...
                        echo '<a href="#" class="button white icon">' . wds_get_svg(TM_URLWCVIDEO . "assets/icons/trash-line.svg") . 'Odstranit</a>';
                        echo '</div></p>';
                    }
                ...
                case 'week':
                    ...
                    echo '<div class="input-group">';
                    echo '<span class="input-group-label">' . wds_get_svg(TM_URLWCVIDEO . $icon) . '</span>';
                    echo $floating_label_start;
                ...
                case 'warning_box':
                    ...
                    echo '<span class="icon">' . wds_get_svg(TM_URLWCVIDEO . $icon) . '</span>';
    ...
    new \wc_video\framework\forms_core\WDS_Front_Form;
}
