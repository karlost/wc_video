<?php 
namespace wc_video\admin\submenu;
if ( ! defined( 'ABSPATH' ) ) {
...

{
...

	{
        ...
        public function submenus_callback() {
            ...
            */
            ...
            $subcontent = new \wc_video\admin\submenu\content\submenuContentWDS;

            $submenus = [
                [
                    'wds-plugins',                              
                    __( 'WC Video', TM_PLUGWCVIDEO ),                    
                    __('WC video', TM_PLUGWCVIDEO),               
                    'manage_options',                           
                    'wds_wc_video',                              
	...
	new \wc_video\admin\submenu\subMenuWDS;
